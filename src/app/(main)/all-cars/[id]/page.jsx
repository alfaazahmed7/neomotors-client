                ...
                <div className="grid gap-10 lg:grid-cols-3">
                    ...
                    <div>
                        <div className="sticky top-24 rounded-3xl border border-white/10 bg-gradient-to-b from-white/10 to-white/5 p-8 backdrop-blur-xl">
                            ...
                            <button className="w-full rounded-2xl bg-white py-4 text-lg font-bold text-black transition hover:bg-gray-200">
                                Book Now
                            </button>

                            <button className="mt-4 w-full rounded-2xl border border-white/15 py-4 text-lg font-bold transition hover:bg-white hover:text-black">
                                Contact Dealer
                            </button>
